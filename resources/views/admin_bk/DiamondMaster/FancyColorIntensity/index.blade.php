            ...
            <form id="mainForm">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body row g-2">
                        <div class="col-12">
                            <label>Name</label>
                            <input type="text" class="form-control" id="fci_name" name="fci_name">
                             <div class="text-danger mt-1" id="error-fci_name"></div> 
                        </div>
                        <div class="col-6">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.editBtn', function() {
                let id = $(this).data('id');
                $.get(`/api/admin/diamond-fancy-color-intensity/${id}`, function(data) {
            ...
            $('#mainForm').submit(function(e) {
                ...
                const id = $('#editId').val();
                const url = id ?
                    `/api/admin/diamond-fancy-color-intensity/${id}` :
            ...
            $(document).ready(function() {
                ...
                $('#confirmDelete').on('click', function() {
                    ...
                    $.ajax({
                        url: `/api/admin/diamond-fancy-color-intensity/${deleteId}`,
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}',
                            _method: 'DELETE'
